        ...
        function (runtime, search, record, error, EXTEND_API, EXTEND_CONFIG) {
                ...
                exports.getShipmentInfo = function (objSalesOrderRecord) {
                        ...
                        itemfulfillmentSearchObj.run().each(function (result) {
                                ...
                                objExtendFulfillmentData[stUniqueKey].productIds = [];
                                objExtendFulfillmentData[stUniqueKey].productIds.push(result.getValue({ name: 'contentsdescription', join: 'shipmentPackage' }));
                ...
                exports.buildExtendShipmentJSON = function (objValues) {
                        ...
                        for (key in objValues) {
                                var objShipmentInfo = {
                                        //required
                                        'productIds': objValues[key].productIds,//array
